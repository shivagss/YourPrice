...
//
//public class BlurToolsPanel extends AbstractContentPanel implements OnDrawListener, OnClickListener, OnItemsScrollListener {
//
...
//
//    private String[] mBlurModes;
//
//    public BlurToolsPanel ( IAviaryController context, ToolEntry entry, ToolLoaderFactory.Tools filter_type ) {
//        super( context, entry );
//
//        mFilterType = filter_type;
//        //mFilterType = ToolLoaderFactory.Tools.TRIANGLE;
...
//
//        mBlurModes = config.getStringArray( R.array.aviary_blur_tool_modes );
//
...
//                    image.setImageResource( R.drawable.aviary_tool_ic_blur );
//                }
//            } else {
//                if ( type == VALID_POSITION ) {
//                }
...
//    }
//
//    //need to figure out how to switch filter on draw thread
//    public void updateTool( int position ) {
//        String tool = mBlurModes[position];
//        mFilterType = ToolLoaderFactory.Tools.valueOf( tool.toUpperCase() );
//        mFilter = createFilter( mFilterType );
//
//        mBackgroundDrawThread.setFilter( mFilter );
//        //mBackgroundDrawThread = new BackgroundDrawThread( "draw-thread", Thread.NORM_PRIORITY, mFilter, mThreadHandler, BRUSH_MULTIPLIER );
//        //mBackgroundDrawThread.start( mBitmap, mPreview );
//    }
//
