...
//		Log.d( LOG_TAG, "availableWidth: " + availableWidth + ", availableHeight: " + availableHeight );
//		Log.d( LOG_TAG, "numHGaps: " + numHGaps + ", numVGaps: " + numVGaps );
//		Log.d( LOG_TAG, "mCellPaddingH: " + mCellPaddingH + ", mCellPaddingV: " + mCellPaddingV );
//		Log.d( LOG_TAG, "mCellWidth: " + mCellWidth + ", mCellHeight: " + mCellHeight );
//		Log.d( LOG_TAG, "hTotalSpace: " + hTotalSpace + ", vTotalSpace: " + vTotalSpace );
//		Log.d( LOG_TAG, "mWidthGap: " + mWidthGap + ", mHeightGap: " + mHeightGap );
...
//				Log.d( LOG_TAG, "setup. position: " + x + "x" + y + ", size: " + width + "x" + height + " gap: " + widthGap + "x" + heightGap );
//			}
		}
	}
